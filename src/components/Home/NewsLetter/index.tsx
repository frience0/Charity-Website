          ...
          <div className="" data-aos="fade-left">
            ...
            <form>
              ...
              <div className="flex justify-center mb-6">
                <button
                  type="submit"
                  className="text-white cursor-pointer bg-linear-to-r from-error to-warning px-7 py-4 dark:hover:from-dark hover:from-white hover:to-white dark:hover:to-dark border border-transparent hover:border-error hover:text-error rounded-sm w-full"
                >
                  Subscribe
                </button>
              </div>
