        ...
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4 grid grid-cols-12">
          ...
          >
            ...
            <p className="text-muted dark:text-white/60 text-base mb-5">
              Help provide African mothers with food, healthcare, and skills to
            ...
            <div className="flex justify-center">
              <button
                ...
                className="text-white bg-linear-to-r cursor-pointer text-sm from-error to-warning px-7 py-4 hover:from-white hover:to-white dark:hover:from-dark dark:hover:to-dark border font-semibold border-transparent hover:border-error hover:text-error rounded-md"
              >
                Donate now
              </button>
              <Test />
