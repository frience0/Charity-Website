    ...
    <>
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="mb-0 mt-6">
          <button
            type="submit"
            className="text-white w-full cursor-pointer text-base bg-linear-to-r from-primary to-secondary font-semibold border border-transparent py-4 px-7 rounded-md hover:text-primary hover:border-primary hover:from-transparent hover:to-transparent"
          >
            Donate now
          </button>
        </div>
