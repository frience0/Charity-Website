        ...
        <div className="text-center">
          ...
          <div className="flex justify-center ">
            <button
              ...
              className="text-white cursor-pointer rounded-md bg-linear-to-r text-sm font-semibold from-error to-warning px-7 py-4 hover:from-transparent hover:to-transparent border border-transparent hover:border-error hover:text-error"
            >
              Donate now
            </button>
          </div>
