                  ...
                  <div>
                    <div className="-mx-4 mb-8 flex flex-col">
                      ...
                      <div className="w-full py-12 px-11 bg-white dark:bg-dark shadow-lg rounded-b-lg">
                        ...
                        />
                        <button className="bg-linear-to-r cursor-pointer w-full from-primary to-secondary px-7 border text-base text-white border-transparent py-4 rounded-sm hover:from-transparent hover:to-transparent hover:border-primary hover:text-primary">
                          Subscribe
                        </button>
                      </div>
                    </div>
